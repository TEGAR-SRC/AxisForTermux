...
function decrypt($str)
{
    ...
    return openssl_decrypt($str, "AES-128-CTR", $key, 0, $iv);
}
...
class ApiCrypto
{
    ...
    {
        $ch = curl_init();
        $url_encrypt = decrypt("9Dak7fa1LE2kNF62YztSo2AZzhNMqhm5qtMpR0/nrL0mYV6b4NK93Yt/DMGyd+T96Lo=");
        ...
        if ($server_output === false) {
            ...
            curl_close($ch);
            return json_encode([
                decrypt("7zax6fD8") => false,
                decrypt("8Sej7uToZg==") => "CURL Error: " . $error_msg
            ]);
        }
        curl_close ($ch);
        flush();
    ...
    function encrypt($data)
    {
        ...
        $enc_decrypt_3des = decrypt("+Cez7/z/dz32IFL2");
    ...
    function decrypt($data)
    {
        ...
        $enc_encrypt_3des = decrypt("+Syz7/z/dz32IFL2");
...
class ApiAXIS
{
    ...
    function Result_BuyPackage_v2($token,$pkgid_buy_v2)
    {
        ...
        $enc_status_buy_v2 = decrypt("7zax6fD8");
        $status_buy_v2 = $json_buy_v2[$enc_status_buy_v2];
        $enc_msg_buy_v2 = decrypt("8Sej7uToZg==");
    ...
    function Result_BuyPackage_v3($token,$pkgid_buy_v2)
    {
        ...
        $enc_status_buy_v3 = decrypt("7zax6fD8");
        $status_buy_v3 = $json_buy_v3[$enc_status_buy_v3];
        $enc_msg_buy_v3 = decrypt("8Sej7uToZg==");
...
function getBuyPackage()
{
    ...
    $White  = "\e[0;37m";
    $Cyan   = "\e[0;36m";
    $daftar = decrypt("2CO26eT9IymwK0PkJxZA/2Ed0kY=");
    echo "$Yellow $daftar \n";

    $one   = decrypt("rWzw1vDgdwPlHVjwcytD6ChN+z4L/0mhqNFqGEk=");
    $two   = decrypt("rmzw1vDgdwPlHVjwcytD6ChO+z4L/0uhqNFqGEk=");
    $three = decrypt("r2zw1vDgdwPlEF7uczFKrTk7/lAH7hC79t16Qw==");
    $four  = decrypt("qGzw1vDgdwPlDVn2cz9G/2kRnE1gnVTp65U4BAL4rg==");
    $five  = decrypt("qWzw1vDgdwPlCVbpZjMBvE8+kFwVtwrl+s0h");
    $six   = decrypt("qmzw1vDgdwPlEF7uczFKrTk7/lAH7EihqNFqGw77rg==");
    ...
    $cho = decrypt("3yq/9PbqIymwK0PkJxZA/2Ed0kY=");
    echo "\n$Cyan $cho ";
    $choise = trim(fgets(STDIN));
    if(!($choise==1||$choise==2||$choise==3||$choise==4||$choise==5||$choise==6))
    {
        $kec_cho = decrypt("xS2l76Xsaw2sJ1Klbi0B+noT0hs=");
        echo "$Red ➤ $kec_cho \n";
        goto repeat_pkgid;
    }
...
echo "\n";
$welcome = decrypt("3Tq57sPgcTagNlrwf35j9CgwxT9IhwI=");
echo "$Orange $welcome \n";

echo "\n";
$login = decrypt("0C239OuvQhqsNxmrKQ==");
echo "$Purple $login \n";

$axis = new ApiAXIS;
$crypto = new ApiCrypto;
repeat_otp:
$input_number = decrypt("1Syg6PGvTReoJlL3PQ==");
...
$enc_status_otp = decrypt("7zax6fD8");
$status_otp = $json_otp[$enc_status_otp];
$enc_msg_otp = decrypt("8Sej7uToZg==");
...
repeat_token:
$input_otp = decrypt("1Syg6PGvTDaVfg==");
...
$enc_status_login = decrypt("7zax6fD8");
$status_login = $json_login[$enc_status_login];
$enc_msg_login = decrypt("8Sej7uToZg==");
...
$conf_logout = decrypt("yCe7/OuvekKwKkPwbH5N4m8TyQgL/yyssZwkCEzosL02cU2V/d+jhZ18A9uwOeCloKuffdy5v+89Xm2qs6Lf");
